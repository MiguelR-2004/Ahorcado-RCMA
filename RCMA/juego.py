...
PALABRAS = [
    "Python", "Diccionarios", "Listas", "Interfaz", "Programación", "GitHub", 
    "Pseudocodigo", "Variables", "Constantes", "Ejecutar", "Estructuras", 
    "Cadenas", "Repositorio", "Sistemas", "Codigos", "Atributos", "Entorno", 
    "Pillow", "Botones", "Etiquetas", "Funciones", "Ventana", "Ratón", 
    "Tkinter", "Componentes", "Texto", "Versión", "Sintaxis", "Imagen", 
    "Contenedor"
]
    ...
    def seleccionar_letra(self, letra):
        ...
        if letra in self.palabra:
            ...
            if self.intentos == self.max_intentos:
                messagebox.showerror("¡Perdiste!", f"La palabra era: {self.palabra}")
                self.iniciar_juego()
